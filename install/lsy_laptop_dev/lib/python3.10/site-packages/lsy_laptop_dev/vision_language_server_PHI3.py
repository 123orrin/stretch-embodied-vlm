...
class VLServer(Node):
    ...
    def vision_language_callback(self, request, response):
        if request.use_image:
            ...
            messages = [ 
                {"role": "user", "content": f"<|image_1|>\n {request.prompt}. Keep your response less than 30 words."} #Keep your response less than 30 words.
            ...
            messages = [ 
                {"role": "user", "content": f"{request.prompt}. Keep your response less than 30 words."} #Keep your response less than 30 words.
                #{"role": "assistant", "content": "The chart displays the percentage of respondents who agree with various statements about their preparedness for meetings. It shows five categories: 'Having clear and pre-defined goals for meetings', 'Knowing where to find the information I need for a meeting', 'Understanding my exact role and responsibilities when I'm invited', 'Having tools to manage admin tasks like note-taking or summarization', and 'Having more focus time to sufficiently prepare for meetings'. Each category has an associated bar indicating the level of agreement, measured on a scale from 0% to 100%."}, 
                #{"role": "user", "content": "Provide insightful questions to spark discussion."} 
            ] 
