...
class GetVoiceCommands:
    ...
    def __init__(self, node):
        ...
        self.small_translate = 0.3

        # Medium step size parameters
        self.medium_deg = 22.5
        self.medium_rad = self.rad_per_deg * self.medium_deg
        self.medium_translate = 1.5

        # Big step size parameters
        self.big_deg = 45.0
        self.big_rad = self.rad_per_deg * self.big_deg
        self.big_translate = 3.0
        ...
        self.speech_to_text_sub = self.node.create_subscription(String, "/yayayay", self.callback_speech, 1)
    ...
    def get_command(self):
        ...
        if self.voice_command == 'forward' or self.voice_command == 'Forward.':
